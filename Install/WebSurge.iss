#define MyAppName "West Wind WebSurge"
#define MyAppVersion GetFileVersion('.\Distribution\WebSurge.exe')
#define MyAppPublisher "West Wind Technologies"
#define MyAppURL "https://websurge.west-wind.com"
#define MyAppExeName "WebSurge.exe"
#define MySetupImageIco "..\WebSurge\WebSurge.ico"
...
AppId={{EEC02DCF-BB1F-4044-88DB-75FA99A9CBDB}
AppName={#MyAppName}
...
OutputBaseFilename=WebSurgeSetup
...
[Dirs]
;Name: "{app}\{#MyAppName}\Addins"; Permissions: everyone-modify
...
Source: ".\DistributionAppData\*"; DestDir: "{userappdata}\West Wind WebSurge"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Root: HKCR; Subkey: ".websurge";                             ValueData: "{#MyAppName}";          Flags: uninsdeletevalue; ValueType: string;  ValueName: ""
Root: HKCR; Subkey: "{#MyAppName}";                    ValueData: "Program {#MyAppName}";  Flags: uninsdeletekey;   ValueType: string;  ValueName: ""
Root: HKCR; Subkey: "{#MyAppName}\DefaultIcon";        ValueData: "{app}\{#MyAppExeName},0";               ValueType: string;  ValueName: ""
Root: HKCR; Subkey: "{#MyAppName}\shell\open\command"; ValueData: """{app}\{#MyAppExeName}"" ""%1""";  ValueType: string;  ValueName: ""

; IE 11 mode
Root: HKCU; Subkey: "Software\Microsoft\Internet Explorer\Main\FeatureControl\FEATURE_BROWSER_EMULATION"; ValueType: dword; ValueName: "WebSurge.exe"; ValueData: "11001"; Flags: createvalueifdoesntexist

; Add WebSurge to user's system path
